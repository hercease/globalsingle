...
<head>
    ...
    <meta property="og:image" content="<?php echo $rootUrl ?>/public/assets/images/logo-white.svg">
    ...
    <meta name="twitter:image" content="<?php echo $rootUrl ?>/public/assets/images/logo-white.svg">
    ...
    <div class="footer-wrapper container-fluid">
      <div class="row">
        <div class="col-sm my-1">
          <p class="m-0">Crafted by Team <a href="#" >GlobalSingleLine</a></p>
        </div>
      </div>
    </div>
  </footer> <!-- Required Js -->
