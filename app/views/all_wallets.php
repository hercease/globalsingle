<html><!-- [Head] start -->
<head>
    <title>All Wallets | GlobalSingleLine</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="title" content="All Wallets | GlobalSingleLine">
    ...
    <meta property="og:title" content="All Wallets | GlobalSingleLine">
    ...
    <meta property="og:url" content="<?php echo $rootUrl ?>/all_wallets">
    <meta property="og:type" content="website">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="All Wallets | GlobalSingleLine">
    ...
    <meta name="twitter:site" content="<?php echo $rootUrl ?>/all_wallets">
    <meta name="theme-color" content="#0a3a66">
    <link rel="canonical" href="<?php echo $rootUrl ?>/all_wallets">
          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">All Wallets</li>
              </ul>
            </div>
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">All Wallets</h2>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card">
                    <!-- Card Body -->
                    <div class="card-body">
                        <table id="all_wallets" class="table table-striped caption-top">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
                                    <th scope="col">Username</th>
                                    <th scope="col">Address</th>
                                    <th scope="col">Usdt Balance</th>
                                    <th scope="col">BNB Balance</th>
...
<script>
        ...
        var usersDataTable = $('#all_wallets').DataTable({
            'processing': true,
            'serverSide': true,
            'serverMethod': 'post',
            'responsive': true,
        ...
        $(document).on("click", ".process_wallet", function(e){

            e.preventDefault();
            let id = $(this).data('id');
            let type = $(this).data('type');
            let msg = $(this).data('message');
            processRequest(id,type,msg);
        ...
        function processRequest(id,type,msg){
            iziToast.question({
                timeout: 20000,
                close: false,
                overlay: true,
