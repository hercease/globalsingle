...
<!-- [Head] start -->
<head>
    <title>Forgot Password | GlobalSingleLine</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
    ...
    <meta property="og:title" content="Forgot Password | GlobalSingleLine">
    ...
    <meta property="og:url" content="<?php echo $rootUrl ?>/forgot_password">
    <meta property="og:type" content="website">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Forgot Password | GlobalSingleLine">
    ...
    <meta name="twitter:site" content="<?php echo $rootUrl ?>/forgot_password">
    <meta name="theme-color" content="#0a3a66">
    <link rel="canonical" href="<?php echo $rootUrl ?>/forgot_password">
    ...
    <div class="auth-wrapper v3">
      <div class="auth-form">
        ...
        <form name="forgot">
          <div class="card-body">
            ...
            <div class="d-flex mt-1 justify-content-between">
              ...
              <h6 class="f-w-400"><a class="text-dark" href="login">Remember Password?</a></h6>
            </div>
        ...
        <div class="auth-footer row">
          <!-- <div class=""> -->
            <div class="col my-1">
              <p class="m-0 text-dark">Copyright © <a href="#">Global Single Line</a></p>
            </div>
